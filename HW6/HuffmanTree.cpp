...
IntervalNode::IntervalNode(int f) { freq = f; }
...
int IntervalNode::getNodeType() { return 1; }

Node* IntervalNode::getLChild() { return lChild; }

Node* IntervalNode::getRChild() { return rChild; }
...
TerminalNode::~TerminalNode() { return; }

int TerminalNode ::getNodeType() { return 0; }

char TerminalNode::getValue() { return value; }
...
void HuffmanTree::clean(Node* par)
{
